            ...
            <tr class="border-b dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors">
                ...
                <td class="px-4 py-3">
                    <div class="flex gap-1 flex-wrap">
                        <button onclick="window.physApp.viewQuestions('${p.id}')" class="text-xs px-2.5 py-1 rounded bg-blue-50 text-blue-700 hover:bg-blue-100 border border-blue-200" title="View Questions">
                            <i class="fas fa-eye mr-1"></i>View
                        </button>
                        <button onclick="window.physApp.edit('${p.id}')" class="text-xs px-2.5 py-1 rounded bg-primary-50 text-primary-700 hover:bg-primary-100" title="Edit">
                            <i class="fas fa-edit"></i>
                        </button>
                        <button onclick="window.physApp.printPaper('${p.id}')" class="text-xs px-2.5 py-1 rounded bg-gray-700 text-white hover:bg-gray-800" title="Print Paper">
                            <i class="fas fa-print"></i>
                        </button>
                        <button onclick="window.physApp.del('${p.id}')" class="text-xs px-2.5 py-1 rounded bg-red-50 text-red-600 hover:bg-red-100" title="Delete">
