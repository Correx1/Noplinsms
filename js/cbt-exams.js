            ...
            <tr class="border-b dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors">
                ...
                <td class="px-4 py-3">
                    <div class="flex flex-wrap gap-1">
                        <button onclick="window.cbtApp.viewQs('${s.id}')" class="text-xs px-2.5 py-1 rounded bg-blue-50 text-blue-700 hover:bg-blue-100 border border-blue-200" title="View Questions">
                            <i class="fas fa-eye mr-1"></i>Questions
                        </button>
                        <button onclick="window.cbtApp.startExam('${s.id}')" class="text-xs px-2.5 py-1 rounded bg-green-600 text-white hover:bg-green-700" title="Start Exam">
                            <i class="fas fa-play mr-1"></i>Start
                        </button>
                        <button onclick="window.cbtApp.edit('${s.id}')" class="text-xs px-2.5 py-1 rounded bg-primary-50 text-primary-700 hover:bg-primary-100" title="Edit">
                            <i class="fas fa-edit"></i>
                        </button>
                        <button onclick="window.cbtApp.toggleStatus('${s.id}')" class="text-xs px-2.5 py-1 rounded bg-yellow-50 text-yellow-700 hover:bg-yellow-100" title="Toggle Status">
                            <i class="fas fa-power-off"></i>
                        </button>
                        <button onclick="window.cbtApp.del('${s.id}')" class="text-xs px-2.5 py-1 rounded bg-red-50 text-red-600 hover:bg-red-100" title="Delete">
